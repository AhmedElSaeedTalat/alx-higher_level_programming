...
class TestBase(unittest.TestCase):
 ...
 {"id": 2, "width": 2, "height": 4, "x": 0, "y": 0}]'
    ...
    def test_load_from_file(self):
        ...
        expected = '[Square] (5) 0/0 - 5'
        self.assertEqual(list_squares_output[0].__str__(), expected)

        expected = '[Square] (6) 9/1 - 7'
        self.assertEqual(list_squares_output[1].__str__(), expected)
